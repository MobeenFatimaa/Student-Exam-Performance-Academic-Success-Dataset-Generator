...
def generate_student_dataset(n_samples=100_000, output_path="student_exam_performance.csv"):
    """
    Generates a synthetic dataset of student academic performance and saves it to a CSV file.
    """
    np.random.seed(42)
    N = n_samples
    ...
    # Calibrate to Mean = 62.0, Std Dev = 16.0
    ...
    print(f"Dataset successfully exported to '{output_path}' ({df.shape[0]} rows, {df.shape[1]} columns).")
